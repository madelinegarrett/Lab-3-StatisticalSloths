...
```
Katie's Findings:
* I, Katie Stewart, created a plot showing how general health and smoking were related and how they differ between age groups. The data showed that those who smoke and are over the age of around 40 are more susceptible to having poor or fair health. I used the geom_bar function to create my graph and added a color fill. I also used the facet_grid function to make it easier to distinguish between those who smoke and those who do not among their age groups. 
